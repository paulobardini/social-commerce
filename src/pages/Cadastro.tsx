        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-foreground mb-1.5">Telefone <span className="text-destructive">*</span></label>
                <input
                  type="tel"
                  value={phone}
            ...
            <div>
              ...
              <input
                ...
                maxLength={255}
              />
              <p className="text-xs text-muted-foreground mt-1">esse e-mail será utilizado para acessar a plataforma</p>
            </div>

            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-foreground mb-1.5">Senha <span className="text-destructive">*</span></label>
              ...
              <div>
                <label className="block text-sm font-medium text-foreground mb-1.5">Confirmar Senha <span className="text-destructive">*</span></label>
                <div className="relative">
                  <input
            ...
            <div className="flex items-center justify-between pt-4">
              <p className="text-sm text-muted-foreground">
                Já possui conta? <Link to="/login" className="text-accent font-medium hover:underline">Entrar</Link>
              </p>
              <button
                type="submit"
