...
export default function MarcaDetalhePage() {
            ...
            >
              ...
              <div className="flex flex-col gap-2 shrink-0 w-full md:w-auto">
                {isConnected ? (
                  <>
                    <Button
                      onClick={() => router.push(`/marca/${brand.slug}/produtos`)}
              ...
              {!isConnected && (
                ...
                >
                  ...
                  <p className="text-sm text-muted-foreground text-center max-w-sm">
                    Conecte-se com <strong className="text-foreground">{brand.name}</strong> para acessar o catálogo
                    completo com preços e fazer pedidos
                  </p>
                  <Button
                    onClick={() => {
                      if (!isAuthenticated) {
