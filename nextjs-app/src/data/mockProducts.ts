...
const pick = (n: number, offset = 0): string[] =>
  Array.from({ length: n }, (_, i) => {
    const img = imgs[(i + offset) % 8];
...
export const brands: Brand[] = [
  {
    slug: "brandili",
    name: "Brandili",
    logo: typeof brandBrandili === "string" ? brandBrandili : brandBrandili.src,
    banner: typeof concept1 === "string" ? concept1 : concept1.src,
    description: "Moda infantil completa em todas as fases e idades.",
    connections: 20,
    totalProducts: 501,
    subBrands: [
      { id: "sb1", name: "BGR", logo: typeof brandBrandili === "string" ? brandBrandili : brandBrandili.src, vitrineImages: [concept1, concept2, concept3, concept5, concept6, concept4, concept7, concept8].map(i => typeof i === "string" ? i : i.src) },
      { id: "sb2", name: "GLINNY", logo: typeof brandKyly === "string" ? brandKyly : brandKyly.src, vitrineImages: [concept7, concept8, concept6, concept2, concept3].map(i => typeof i === "string" ? i : i.src) },
      { id: "sb3", name: "PINK SODA", logo: typeof brandHering === "string" ? brandHering : brandHering.src, vitrineImages: [concept4, concept3, concept5, concept1, concept8].map(i => typeof i === "string" ? i : i.src) },
      { id: "sb4", name: "BOCA GRANDE", logo: typeof brandMalwee === "string" ? brandMalwee : brandMalwee.src, vitrineImages: [concept2, concept6, concept1, concept7, concept4].map(i => typeof i === "string" ? i : i.src) },
    ],
  ...
  },
  {
    slug: "kyly",
    name: "Kyly",
    logo: typeof brandKyly === "string" ? brandKyly : brandKyly.src,
    banner: typeof concept3 === "string" ? concept3 : concept3.src,
    description: "Streetwear infantil moderno e colorido.",
    connections: 15,
    totalProducts: 380,
    subBrands: [
      { id: "ky-sb1", name: "KYLY", logo: typeof brandKyly === "string" ? brandKyly : brandKyly.src, vitrineImages: [concept3, concept1, concept5, concept7].map(i => typeof i === "string" ? i : i.src) },
      { id: "ky-sb2", name: "MILON", logo: typeof brandKyly === "string" ? brandKyly : brandKyly.src, vitrineImages: [concept2, concept4, concept6, concept8].map(i => typeof i === "string" ? i : i.src) },
    ],
  ...
  },
  {
    slug: "hering",
    name: "Hering",
    logo: typeof brandHering === "string" ? brandHering : brandHering.src,
    banner: typeof concept5 === "string" ? concept5 : concept5.src,
    description: "Básicos reinventados com alfaiataria moderna.",
    connections: 45,
    totalProducts: 720,
    subBrands: [
      { id: "hr-sb1", name: "HERING", logo: typeof brandHering === "string" ? brandHering : brandHering.src, vitrineImages: [concept5, concept1, concept3, concept7].map(i => typeof i === "string" ? i : i.src) },
      { id: "hr-sb2", name: "HERING KIDS", logo: typeof brandHering === "string" ? brandHering : brandHering.src, vitrineImages: [concept2, concept6, concept4, concept8].map(i => typeof i === "string" ? i : i.src) },
    ],
  ...
  },
  {
    slug: "malwee",
    name: "Malwee",
    logo: typeof brandMalwee === "string" ? brandMalwee : brandMalwee.src,
    banner: typeof concept4 === "string" ? concept4 : concept4.src,
    description: "Moda sustentável com texturas e tricôs artesanais.",
    connections: 18,
    totalProducts: 450,
    subBrands: [
      { id: "mw-sb1", name: "MALWEE", logo: typeof brandMalwee === "string" ? brandMalwee : brandMalwee.src, vitrineImages: [concept4, concept8, concept5, concept2].map(i => typeof i === "string" ? i : i.src) },
      { id: "mw-sb2", name: "MALWEE KIDS", logo: typeof brandMalwee === "string" ? brandMalwee : brandMalwee.src, vitrineImages: [concept1, concept3, concept6, concept7].map(i => typeof i === "string" ? i : i.src) },
    ],
  ...
  },
  {
    slug: "lunender",
    name: "Lunender",
    logo: typeof brandLunender === "string" ? brandLunender : brandLunender.src,
    banner: typeof concept2 === "string" ? concept2 : concept2.src,
    description: "Elegância contemporânea para mulheres sofisticadas.",
    connections: 22,
    totalProducts: 390,
    subBrands: [
      { id: "ln-sb1", name: "LUNENDER", logo: typeof brandLunender === "string" ? brandLunender : brandLunender.src, vitrineImages: [concept2, concept7, concept4, concept6].map(i => typeof i === "string" ? i : i.src) },
      { id: "ln-sb2", name: "LUNELLI", logo: typeof brandLunender === "string" ? brandLunender : brandLunender.src, vitrineImages: [concept1, concept5, concept3, concept8].map(i => typeof i === "string" ? i : i.src) },
    ],
  ...
  },
  {
    slug: "marisol",
    name: "Marisol",
    logo: typeof brandMarisol === "string" ? brandMarisol : brandMarisol.src,
    banner: typeof concept6 === "string" ? concept6 : concept6.src,
    description: "Candy colors e estampas vibrantes para crianças.",
    connections: 16,
    totalProducts: 340,
    subBrands: [
      { id: "ms-sb1", name: "MARISOL", logo: typeof brandMarisol === "string" ? brandMarisol : brandMarisol.src, vitrineImages: [concept6, concept2, concept8, concept4].map(i => typeof i === "string" ? i : i.src) },
      { id: "ms-sb2", name: "LILICA RIPILICA", logo: typeof brandMarisol === "string" ? brandMarisol : brandMarisol.src, vitrineImages: [concept7, concept1, concept3, concept5].map(i => typeof i === "string" ? i : i.src) },
    ],
  ...
  },
  {
    slug: "elian",
    name: "Elian",
    logo: typeof brandElian === "string" ? brandElian : brandElian.src,
    banner: typeof concept7 === "string" ? concept7 : concept7.src,
    description: "Paletas earth tones com design atemporal.",
    connections: 8,
    totalProducts: 280,
    subBrands: [
      { id: "el-sb1", name: "ELIAN", logo: typeof brandElian === "string" ? brandElian : brandElian.src, vitrineImages: [concept7, concept4, concept8, concept2].map(i => typeof i === "string" ? i : i.src) },
      { id: "el-sb2", name: "COLORITTÁ", logo: typeof brandColoritta === "string" ? brandColoritta : brandColoritta.src, vitrineImages: [concept3, concept5, concept1, concept6].map(i => typeof i === "string" ? i : i.src) },
    ],
  ...
  },
  {
    slug: "colorittá",
    name: "Colorittá",
    logo: typeof brandColoritta === "string" ? brandColoritta : brandColoritta.src,
    banner: typeof concept8 === "string" ? concept8 : concept8.src,
    description: "Coleções florais e estampas exclusivas.",
    connections: 7,
    totalProducts: 220,
    subBrands: [
      { id: "ct-sb1", name: "COLORITTÁ", logo: typeof brandColoritta === "string" ? brandColoritta : brandColoritta.src, vitrineImages: [concept8, concept2, concept6, concept4].map(i => typeof i === "string" ? i : i.src) },
    ],
