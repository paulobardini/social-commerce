...
const posts = [concept1, concept2, concept3, concept4, concept5, concept6, concept7, concept8];
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <div className="mt-4 space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Curadoria de tendências e coleções para multimarcas 🛍️
                  </p>
                  ...
                  >
                    <div className="grid grid-cols-2 grid-rows-2 gap-0.5 rounded-xl md:rounded-2xl overflow-hidden aspect-square">
                      <div className="row-span-2 col-span-1 overflow-hidden">
                        <img
                          src={typeof board.images[0] === "string" ? board.images[0] : board.images[0].src}
                          alt=""
                      ...
                      <div className="overflow-hidden">
                        <img
                          src={typeof board.images[1] === "string" ? board.images[1] : board.images[1].src}
                          alt=""
                          className="h-full w-full object-cover transition-transform group-hover:scale-105"
                        />
                      </div>
                      <div className="overflow-hidden">
                        <img
                          src={typeof board.images[2] === "string" ? board.images[2] : board.images[2].src}
                          alt=""
                          className="h-full w-full object-cover transition-transform group-hover:scale-105"
                        />
                      </div>
