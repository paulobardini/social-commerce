...
const brands = [
  { name: "Brandili", logo: brandBrandili, category: "Infantil", description: "Moda infantil com estampas lúdicas e conforto premium", followers: "12.5k", posts: [concept1, concept3, concept6] },
  { name: "Kyly", logo: brandKyly, category: "Infantil", description: "Streetwear infantil moderno e colorido", followers: "9.8k", posts: [concept3, concept1] },
  { name: "Hering", logo: brandHering, category: "Masculino", description: "Básicos reinventados com alfaiataria moderna", followers: "45.2k", posts: [concept5] },
  { name: "Malwee", logo: brandMalwee, category: "Sustentável", description: "Moda sustentável com texturas e tricôs artesanais", followers: "18.3k", posts: [concept4, concept8, concept5] },
  { name: "Lunender", logo: brandLunender, category: "Feminino", description: "Elegância contemporânea para mulheres sofisticadas", followers: "22.1k", posts: [concept2, concept7] },
  { name: "Marisol", logo: brandMarisol, category: "Infantil", description: "Candy colors e estampas vibrantes para crianças", followers: "15.7k", posts: [concept6] },
  { name: "Elian", logo: brandElian, category: "Feminino", description: "Paletas earth tones com design atemporal", followers: "8.4k", posts: [concept7, concept4, concept8] },
  { name: "Colorittá", logo: brandColoritta, category: "Infantil", description: "Coleções florais e estampas exclusivas", followers: "6.9k", posts: [concept8, concept2] },
];
            ...
            >
              <div className={`h-32 md:h-40 overflow-hidden md:grid md:gap-0.5 ${
                ...
                <div className="md:hidden h-full overflow-hidden">
                  <img src={brand.posts[0]} alt="" loading="lazy" className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-105" />
                </div>
                {brand.posts.map((img, j) => (
                  <div key={j} className="hidden md:block overflow-hidden h-full">
                    <img src={img} alt="" loading="lazy" className={`h-full w-full transition-transform duration-500 group-hover:scale-105 ${brand.posts.length === 1 ? "object-contain bg-muted" : "object-cover"}`} />
                  </div>
                ))}
              </div>
              <div className="p-2.5 md:p-4">
                <div className="flex items-center gap-2 md:gap-3">
                  <img src={brand.logo} alt={brand.name} className="h-8 w-8 md:h-12 md:w-12 rounded-full object-cover border-2 border-border" loading="lazy" />
